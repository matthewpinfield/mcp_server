...
def main():
    ...
    if staqc_tests:
        ...
        print(f"⚠️  Using golden test set only with {len(golden_tests)} questions")
    ...
    if evaluation_results:
        ...
        print(f"\n⏱️  Evaluation completed in {end_time - start_time:.2f} seconds")
        ...
        if success_rate >= 95:
            ...
            print(f"\n⚠️  DATABASE QUALITY: ACCEPTABLE ({success_rate:.1f}% success rate)")
        else:
