...
==============================================
Contains RAG tools for Flutter / Dart docs and code search.
"""
...
class LangchainFlutterDocTool(AsyncTool):
    ...
    def _run(self, query: str, max_results: int = 10) -> str:
        ...
        try:
                    ...
                    if results:
                        ...
                        for i, result in enumerate(
                            ...
                            if len(text) > 2000:
                                text = (
                                    text[:2000]
                                    + "...\n[Content truncated - use more specific search terms for complete results]"
                                )
            ...
            return f"**Flutter/Dart Documentation** (Knowledge cutoff: July 26, 2025)\nDocumentation found for query '{query}':\n{result_text}"
        ...
        try:
            ...
            if result and result.get("results"):
                ...
                if docs:
                    ...
                    return f"**Code Examples Database** (Knowledge cutoff: July 26, 2025)\n{formatted_response}"
                else:
