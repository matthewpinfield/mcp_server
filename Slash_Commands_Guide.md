...
**Example**: `/status`  
**Use Case**: Check repository status instantly

#### `/commit <message>`
**Purpose**: Quick git commit  
**Example**: `/commit Add new feature`  
**Use Case**: Fast commits with messages

#### `/branch [action] [name]`
**Purpose**: Git branch operations  
**Example**: `/branch create feature-auth`  
**Options**: list, create, checkout, delete  
**Use Case**: Branch management
...
**Categories**: memory, development, git, system, project, custom  
